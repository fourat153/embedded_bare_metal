...
app\ layer/test_uart_polling.o: ../app\ layer/test_uart_polling.c app\ layer/subdir.mk
	arm-none-eabi-gcc "$<" -mcpu=cortex-m3 -std=gnu11 -g -c -I"C:/Users/ahmed/Desktop/github/embedded_diploma/embedded_diplom/learn_in_depth/Unit_8_MCU_Interfacing/lesson_3_USART_stm/UART_DRIVER/MCAL" -O0 -ffunction-sections -fdata-sections -Wall -gdwarf-2 -fstack-usage -fcyclomatic-complexity -MMD -MP -MF"app layer/test_uart_polling.d" -MT"$@" --specs=nano.specs -mfloat-abi=soft -mthumb -o "$@"
