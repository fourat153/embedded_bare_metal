...
#include "../../SPI/MCAL/inc/stm32f103c6tx_EXTI.h"
...
static void Update_EXTI(EXTI_PinConfig_t* EXTI_Config)
{
	 ...
	 */
	// 4 EXTICR control register each control register control 4 EXTI,
	// and each exti in one control register control the port to be active represented by 3 bits
	// AFIO_EXTICR_index set which register 0 , 1 , 2 , 3
	uint8_t AFIO_EXTICR_index = EXTI_Config->EXTI_Pin.EXTI_InputLineNumber / 4;
	// AFIO_EXTICR_position for the position of the exti it can be 0 , 1 , 2 , 3
	...
	// extract from AFIO_GPIO_EXTI_Mapping which port a , b ,c , d and shift the configuration to the right position and or it in
	// the right register
