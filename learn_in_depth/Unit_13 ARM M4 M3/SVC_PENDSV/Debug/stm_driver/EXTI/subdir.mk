...
stm_driver/EXTI/%.o stm_driver/EXTI/%.su stm_driver/EXTI/%.cyclo: ../stm_driver/EXTI/%.c stm_driver/EXTI/subdir.mk
	arm-none-eabi-gcc "$<" -mcpu=cortex-m3 -std=gnu11 -g3 -c -I"C:/Users/mm77/Desktop/lean/embedded_diplom/learn_in_depth/Unit_13 ARM M4 M3/SVC_PENDSV" -O0 -ffunction-sections -fdata-sections -Wall -gdwarf-2 -fstack-usage -fcyclomatic-complexity -MMD -MP -MF"$(@:%.o=%.d)" -MT"$@" --specs=nano.specs -mfloat-abi=soft -mthumb -o "$@"
