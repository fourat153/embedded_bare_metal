...
stm_driver/GPIO/%.o stm_driver/GPIO/%.su stm_driver/GPIO/%.cyclo: ../stm_driver/GPIO/%.c stm_driver/GPIO/subdir.mk
	arm-none-eabi-gcc "$<" -mcpu=cortex-m3 -std=gnu11 -g3 -c -I"C:/Users/mm77/Desktop/lean/embedded_diplom/learn_in_depth/Unit_13 ARM M4 M3/ARM2_CPU_MODES" -O0 -ffunction-sections -fdata-sections -Wall -gdwarf-2 -fstack-usage -fcyclomatic-complexity -MMD -MP -MF"$(@:%.o=%.d)" -MT"$@" --specs=nano.specs -mfloat-abi=soft -mthumb -o "$@"
